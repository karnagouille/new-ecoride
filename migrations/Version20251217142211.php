 ...
 */
final class Version20251217142211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carpooling DROP price, CHANGE start_town start_town VARCHAR(255) DEFAULT NULL, CHANGE end_town end_town VARCHAR(255) DEFAULT NULL, CHANGE start_at start_at DATETIME DEFAULT NULL, CHANGE hour hour TIME DEFAULT NULL, CHANGE traveltime traveltime VARCHAR(255) DEFAULT NULL, CHANGE note note VARCHAR(255) DEFAULT NULL, CHANGE statut statut VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carpooling ADD price DOUBLE PRECISION NOT NULL, CHANGE start_town start_town VARCHAR(255) DEFAULT \'NULL\', CHANGE end_town end_town VARCHAR(255) DEFAULT \'NULL\', CHANGE start_at start_at DATETIME DEFAULT \'NULL\', CHANGE hour hour TIME DEFAULT \'NULL\', CHANGE traveltime traveltime VARCHAR(255) DEFAULT \'NULL\', CHANGE note note VARCHAR(255) DEFAULT \'NULL\', CHANGE statut statut VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE comment CHANGE comment comment VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
